...
function add_style(){
    ...
    wp_enqueue_style( 'gulp-styles', get_template_directory_uri() . '/css/style.min.css', array('fotorama'), '1');    
}
...
function add_script(){
    ...
    wp_enqueue_script( 'yamap', get_template_directory_uri() . '/js/script.js', array(), '1', true);
    wp_enqueue_script( 'my-script', get_template_directory_uri() . '/js/script.js', array(), '1', true);
    wp_enqueue_script( 'gulp-script', get_template_directory_uri() . '/js/script.min.js', array(), '1', true);
    wp_enqueue_script( 'fotorama-js', get_template_directory_uri() . '/js/fotorama.js', array(), '1'); 
    wp_localize_script( 'gulp-script', 'img',
    array(
